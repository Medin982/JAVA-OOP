...
import ExamPreparation.Exam10April21.aquarium.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addAquarium(String[] data) {
        String type = data[0];
        String name = data[1];
        return this.controller.addAquarium(type, name);
    }
    ...
    private String insertDecoration(String[] data) {
        ...
        String decorationName = data[1];
        return this.controller.insertDecoration(aquariumName, decorationName);
    }
